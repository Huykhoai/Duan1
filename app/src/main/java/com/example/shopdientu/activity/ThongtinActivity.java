...
import com.example.shopdientu.databinding.ActivityThongtinBinding;
...
public class ThongtinActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(21.0513864, 105.7370423);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Làng Nguyên Xá"));
